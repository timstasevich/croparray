...
- Edits are staged in memory until "Save/Update" is pressed.
- "Save to file" optionally overwrites the source dataset after confirmation."""
        return _impl_TrackArrayView_manual_filter_montage(self.ds, row=row, col=col, filter_name=filter_name, show=show, ch=ch, z_index=z_index, viewer=viewer, write_back=write_back, overlay_opacity=overlay_opacity, single_click_delay_ms=single_click_delay_ms, colormaps=colormaps, label_colors=label_colors, output_dir=output_dir, show_click_info=show_click_info, show_tile_text=show_tile_text)
...
- Edits are staged in memory until "Save/Update" is pressed.
- "Save to file" optionally overwrites the source dataset after confirmation."""
        return _impl_TrackArrayNapari_manual_filter_montage(self.ds, row=row, col=col, filter_name=filter_name, show=show, ch=ch, z_index=z_index, viewer=viewer, write_back=write_back, overlay_opacity=overlay_opacity, single_click_delay_ms=single_click_delay_ms, colormaps=colormaps, label_colors=label_colors, output_dir=output_dir, show_click_info=show_click_info, show_tile_text=show_tile_text)
