...
from croparray.measure import measure_mask_props as _impl_CropArrayMeasure_measure_mask_props
...
class CropArrayMeasure(_BaseAccessor):
    ...
    def measure_mask_props(self, source, out_prefix=None, props=('area_px', 'eccentricity', 'solidity', 'perimeter_px', 'centroid_y_px', 'centroid_x_px'), connectivity=2, empty_value=float("nan")):
        return _impl_CropArrayMeasure_measure_mask_props(self.ds, source=source, out_prefix=out_prefix, props=props, connectivity=connectivity, empty_value=empty_value)
...
CropArrayMeasure.measure_mask_props.__doc__ = _impl_CropArrayMeasure_measure_mask_props.__doc__
...
class TrackArrayPlot(_BaseAccessor):
    """Generated accessor methods."""
    def plot_trackarray_crops(self, fov=0, track_id=1, t=(0, 10, 3), rolling=1, quantile_range=(0.02, 0.99), rgb_channels=(0, 1, 2), ch=None, suppress_labels=True, show_suptitle=True):
        return _impl_TrackArrayPlot_plot_trackarray_crops(self.ds, fov, track_id, t, rolling, quantile_range, rgb_channels, ch, suppress_labels, show_suptitle)
